    ...
    <main className="container space-y-8 py-12">
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/demo/admin" className="ghost-btn px-4 py-2 text-xs">Открыть демо-модерацию</Link>
        </div>
        <p className="text-sm text-white/70">Для просмотра детального аудита нужно реализовать фронт-таблицу; бэкенд уже готов.</p>
      </div>
    </main>
  );
}
