    ...
    const loadRefs = async () => {
      try {
        const [clubsRes, leaguesRes, seasonsRes] = await Promise.all([
          apiFetch<RefOption[]>("/refs/clubs"),
          apiFetch<RefOption[]>("/refs/leagues"),
          apiFetch<RefOption[]>("/refs/seasons")
        ]);
        setClubs(clubsRes);
    ...
    <main className="min-h-screen bg-secondary">
      <div className="container space-y-8 py-12">
        <div className="flex items-center justify-between">
          ...
          <Link href="/player/dashboard" className="ghost-btn">
            К дашборду
          </Link>
        </div>
        ...
        {profile && (
          <form className="space-y-6" onSubmit={save}>
            ...
            <div className="flex gap-3">
              ...
              <Link href="/player/dashboard" className="ghost-btn px-5 py-3 text-sm">
                Отмена
              </Link>
            </div>
          </form>
