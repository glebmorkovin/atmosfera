                  ...
                  <tr key={card.id} className="border-t border-white/10">
                    ...
                    <td className="p-3 text-right">
                      <div className="flex justify-end gap-2">
                        <Link href={`/app/club/working/${card.id}`} className="ghost-btn px-3 py-1 text-xs">
                          Карточка
                        </Link>
                        <Link href={`/app/club/players/${card.playerId}`} className="ghost-btn px-3 py-1 text-xs">
                          Профиль
                        </Link>
                      </div>
                    </td>
