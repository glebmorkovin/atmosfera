    ...
    <main className="min-h-screen bg-secondary">
      <div className="container space-y-8 py-12">
        <div className="flex items-center justify-between">
          <div>
            <p className="pill mb-2">Клуб • Запросы</p>
            <h1 className="text-3xl font-bold">Исходящие запросы</h1>
            <p className="text-white/70">Контакты с игроками и статус согласования.</p>
        ...
        {items.length === 0 && !loading && (
          <div className="card text-white/70">Запросов пока нет. Инициируйте контакт из поиска игроков.</div>
        )}
