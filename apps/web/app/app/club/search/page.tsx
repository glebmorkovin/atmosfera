...
export default function ClubSearchPage() {
  ...
  }, [players, position, hasVideo]);

  const saveFilter = async (e: FormEvent) => {
    e.preventDefault();
    ...
    <main className="min-h-screen bg-secondary">
      <div className="container space-y-8 py-12">
        <div className="flex items-center justify-between">
          <div>
            <p className="pill mb-2">Клуб • Поиск</p>
            <h1 className="text-3xl font-bold">Поиск игроков</h1>
            <p className="text-white/70">Подберите кандидатов по позиции, лиге и наличию видео.</p>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <label className="space-y-2 text-sm text-white/80">
              ...
              <div className="space-y-2">
                ...
                />
                <datalist id="club-league-options">
                  {leagues.map((l) => (
            ...
            <div key={p.id} className="card space-y-2">
              ...
              <div className="flex items-center justify-between text-xs text-white/60">
                ...
                <div className="flex gap-2">
                  <Link href={`/app/club/players/${p.id}`} className="text-primary">
                    Профиль
                  </Link>
                  <Link href="/app/club/shortlists" className="text-white/60 hover:text-primary">
                    Шортлисты
                  </Link>
                  {targetShortlist && (
                    <button
